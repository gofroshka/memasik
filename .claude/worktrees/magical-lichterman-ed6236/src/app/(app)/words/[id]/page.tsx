        ...
        <CardContent className="space-y-5 p-6 md:p-8">
          ...
          <div className="space-y-1.5">
            ...
            <div className="flex flex-wrap items-center gap-x-3 gap-y-1">
              ...
              <SpeakButton text={word.word} lang="en-US" variant="icon" title="Озвучить (English)" />
              {word.transcription_en && (
                <span className="text-base font-normal text-muted-foreground">[{word.transcription_en}]</span>
              )}
              {(viewCount ?? 0) > 0 && (
            ...
            <div className="flex flex-wrap items-center gap-x-2 gap-y-1 text-lg font-bold text-primary">
              <Languages className="size-5" />
              <span>{word.translation}</span>
              <SpeakButton text={word.translation} lang="ru-RU" variant="icon" title="Озвучить перевод" />
              {word.transcription && (

      ...
      <table className="min-w-max w-full text-sm">
        <thead className="border-b border-border bg-muted/40">
          <tr>
            ...
            <th className={th} style={{minWidth: 140}}>Транскр. EN</th>
            <th className={th} style={{minWidth: 140}}>Транскр. RU</th>
        ...
        <tbody className="divide-y divide-border">
          ...
          {words.map(word => (
            <tr key={word.id} className="transition-colors hover:bg-muted/20">
              ...
              <td className={td}>
                <InlineCellEdit wordId={word.id} field="transcription_en" value={word.transcription_en} placeholder="—" inputClassName="w-[130px]" />
              </td>
              <td className={td}>
